...
class YtAudioDownloader:
    ...
    _po_token = "MltHKNNS1jDUTEcQWsKYfYqa2yV543xcRNEkkKlcl4ZTjItAfiy5Zi9OQVUHcNc5Vaz_l3ap7L3ootOsQ6zMf_yIQfBUykttm2cn-_DFOhK_jShgO_UaAZkBhRdm"
    ...
    def _download(self):
        ...
        video_path = video.download(
            ...
            filename=self._sanitaze_filename(video.title, "m4a"),
        )
        audio_path = audio.download(
            output_path=self._temp_dir,
            filename=self._sanitaze_filename(audio.title, "mp3"),
        )
